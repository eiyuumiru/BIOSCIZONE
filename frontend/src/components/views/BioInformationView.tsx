        ...
        <div className="min-h-screen pt-28 pb-20 bg-[#EDEDED]">
            <div className="container mx-auto px-8 md:px-12 lg:px-20 max-w-5xl">
                <div className="text-center mb-10">
                    <h2 className={`text-3xl font-extrabold text-[#000033] ${styles.fonts.heading}`}>BIO-INFORMATION</h2>
                    <p className="text-gray-600 mt-2">Thông tin hữu ích về Khoa Sinh học, Bộ môn và Phòng thí nghiệm.</p>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20 text-gray-500">
                        <p>{searchQuery ? 'Không tìm thấy kết quả phù hợp.' : 'Chưa có thông tin nào trong Bio-Information.'}</p>
                    </div>
                ) : (
                    <div className="space-y-4">
                        {filteredArticles.map((item) => (
                            <div
                                ...
                                className="bg-white p-6 md:p-8 rounded-lg shadow-sm hover:shadow-md transition border-l-4 border-transparent hover:border-[#0099FF] group cursor-pointer"
                            >
                                <div className="flex items-start gap-4">
                                    <div className="hidden sm:flex flex-col items-center justify-center min-w-[60px] text-center">
                                        <Info size={32} className="text-gray-300 mb-1 group-hover:text-[#0099FF] transition" />
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-gray-600 italic mb-1">{item.author || 'Admin'}</p>
