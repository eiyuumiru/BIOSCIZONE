...
import MagazineModal from '../layout/MagazineModal';

interface BioMagazineViewProps {
    onMagazineSubmitSuccess: () => void;
}

const BioMagazineView: FC<BioMagazineViewProps> = ({ onMagazineSubmitSuccess }) => {
            ...
            <div className="container mx-auto px-8 md:px-12 lg:px-20 max-w-5xl">
                <div className="flex flex-col md:flex-row justify-between items-end mb-10 border-b border-gray-300 pb-4">
                    ...
                    <button
                        ...
                        className="mt-4 md:mt-0 px-6 py-2 bg-[#000033] text-white font-bold rounded hover:bg-[#0066CC] transition flex items-center gap-2"
                    >
