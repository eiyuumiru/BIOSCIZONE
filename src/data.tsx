...
export const newsItems: NewsItem[] = [
    ...
    { id: 2, title: "Công bố kết quả Nghiên cứu khoa học sinh viên cấp Khoa 2025", date: "10/01/2026", category: "Tin tức" },
    { id: 3, title: "Kỹ năng viết bài báo khoa học chuẩn APA", date: "05/01/2026", category: "Hướng dẫn" }
];

export const bioBuddies: BioBuddy[] = [
    {
        id: 1,
        name: "Nguyễn Văn A",
        course: "K22",
...
export const resourcesList: ResourceItem[] = [
    ...
    { id: 2, title: "Quy trình đăng ký đề tài Nghiên cứu khoa học cấp Trường", date: "08/01/2026", type: "guide", icon: <FileText size={24} /> },
    { id: 3, title: "Tổng hợp các tạp chí khoa học uy tín ngành Sinh học", date: "01/01/2026", type: "list", icon: <BookOpen size={24} /> },
];

export const scienceCornerItems: ScienceCornerItem[] = [
...
export const bioMagazineItems: BioMagazineItem[] = [
...
export const achievementsItems: AchievementItem[] = [
